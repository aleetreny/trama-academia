...
La instantánea local preparada tras la revisión contiene **3.629 registros, 3.201 fuentes, 3.186 semillas y 6.360 instituciones**. Son **256 altas** sobre la referencia anterior: 251 programas de máster verificados y cinco escuelas de verano. El directorio recurrente agrupa 19 fichas y las guías cubren 31 países. El [informe de revisión](review-2026-09-21.md) documenta los denominadores, correcciones y límites.

**Validación local completada; publicación en curso.** Pasan 213 pruebas Node, dos PDF, tipos y lint sin avisos. El build de 3.629 fichas comprueba 88.758 referencias internas y los presupuestos. La revisión de navegador confirma filtros, comparación, teclado, recuperación de errores, móvil y tableta. Las 13 correcciones de fichas existentes están verificadas. La [actualización semanal 35586680322](https://github.com/aleetreny/trama-academia/actions/runs/35586680322) debe integrarse antes de sincronizar y publicar esta edición; el [informe](review-2026-09-21.md#validación-y-publicación) registra el cierre.
