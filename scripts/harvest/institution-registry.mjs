...
let previous;try{previous=await readInstitutionRegistry(output);}catch(error){if(error.code!=='ENOENT')throw error;}
...
await writeInstitutionRegistry(data,output);await fs.writeFile('work/discovery/institution-matches.json',JSON.stringify(matches,null,2));
