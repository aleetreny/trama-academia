...
if(exists.length){await sql.query('GRANT SELECT,INSERT,UPDATE ON opportunities,sources,crawl_runs,observations,institutions,institution_editions TO trama_writer');console.log('Writer grants updated; existing credential preserved');process.exit(0);}
...
await sql.query('GRANT SELECT,INSERT,UPDATE ON opportunities,sources,crawl_runs,observations,institutions,institution_editions TO trama_writer');
