...
export function Header(){return <><a className="skip-link" href="#contenido">Saltar al contenido</a><header className="site-header wrap"><Link className="wordmark" href="/" aria-label="TRAMA, inicio"><GitBranch strokeWidth={1.8}/><span>trama<span className="brand-dot">.</span></span></Link><SiteNav/><Link className="header-index" href="/fuentes">Índice de fuentes <ArrowUpRight size={16}/></Link></header></>}
